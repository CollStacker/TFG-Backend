...
describe('productField repository unit test', () => {
  ...
  beforeEach(async () => {
    ...
    productFieldData = {_id: '1', key: 'newKey', value: 'newValue', type: 'newtype'};
  });
  ...
  it('Create a new productField', async () => {
    const createdProductField = await productFieldRepository.create({key: 'newKey', value: 'newValue', type: 'newtype'});
